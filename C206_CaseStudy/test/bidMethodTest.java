...
public class bidMethodTest {
	...
	public void addBidTest() {
		// Bid list is not null, so that can add a new item - Boundary Test
	...
	public void searchBid() {
		// bid list is not null, so that can add a bid - boundary
		...
		// Search bid based on item Name and ensure bid exists by comparison
		String Realoutput = bidMethod.searchByItemName(bidList);
		String output = bidList.get(0).toString();
		assertEquals("Check that search returns correct bid", Realoutput, output);
	}
